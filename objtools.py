...
def showObjCam(mesh_path, cam, z=1, save_image = False, show_3d = True):
...
def showFolderCam(folder_path, cam, z=1, save_image = False, show_size = False, show_3d = True, name = ""):
